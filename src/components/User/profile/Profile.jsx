                                ...
                                <article>
                                    ...
                                    <div>
                                        <div className="relative">
                                            <p className=" text-lg text-gray-500 absolute top-0 right-0 m-4">
                                                Date Joined: 
                                            ...
                                            <div className="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                                                ...
                                                <div className="mt-6 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                                                    <div className=" flex flex-col 2xl:block mt-10 min-w-0 flex-1">
                                                        ...
                                                        {/* Who view my profile */}
                                                        <div className="flex flex-row  items-center  mb-2 max-w-lg whitespace-nowrap">
                                                            <EyeIcon className="h-5 w-5 " />
                                                            <div className="pl-2">
                                                                {profile?.viewedBy?.length}{" "}
                                                                <span className="text-indigo-400 cursor-pointer hover:underline whitespace-nowrap">
                                                                    Profile View
                                                                </span>
                                                            </div>
                                                        </div>
                                            ...
                                            {profile?.posts?.length <= 0 ? (
                                                ...
                                                profile?.posts?.map(
                                                    (post) => (
                                                        <div
                                                            key={post._id}
                                                            className="flex flex-wrap   mt-3  lg:mb-6"
                                                        >
